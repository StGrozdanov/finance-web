...
const methods = [
  ...
  },
  {
    ...
    description:
      'We support over 15 wallets including MetaMask, WalletConnect, eToro Money etc.',
    icon: '🔗',
    enabled: false,
  },
  {
    ...
    title: 'Demo Data',
    description:
      "Explore the platform's functionality with our demo portfolios, complete with sample data",
    icon: '📊',
    enabled: true,
  },
];
